...
public class BSTree {
    ...
    void insert(String xOwner, int xPrice, int xColor) {
        ...
        p = root;
        while (p != null) {
            if (p.getInfo().getPrice() == x.getPrice()) {
                return;
            }
            f = p;
            if (x.getPrice() < p.getInfo().getPrice()) {
                p = p.left;
            } else {
                p = p.right;
            }
        }
        if (x.getPrice() < f.getInfo().getPrice()) {
            f.left = q;
        } else {
            f.right = q;
        }
    ...
    void f3() throws Exception {
         ...
         * (J,5,5) (I,3,9) (F,2,3) (G,7,8) (D,6,1) (V,94,12) (E,9,4) (C,8,2)
         */
        //---------------------------------------------------------------------------------------
        //------ Start your code here------------------------------------------------------------
        int k = maxdepth(root);
    ...
    void preOrder_f4(Node node) {
        ...
        preOrder_f4(node.left);
        preOrder_f4(node.right);
    }
    ...
    void f4() throws Exception {
        ...
        f.writeBytes("\r\n");
        /**
         * Question 2.4: Reset the Bird's color of all leaf Nodes to 0 Hint:
         ...
         * method is (H,1,7) (K,4,6) (J,5,5) (I,3,9) (F,2,3) (G,7,8)
         * (D,6,1)(E,9,4) (C,8,2) (H,1,0) (K,4,0) (J,5,5) (I,3,9) (F,2,3)
         * (G,7,0) (D,6,1) (E,9,0) (C,8,2)
         */
        //---------------------------------------------------------------------------------------
        //------ Start your code here------------------------------------------------------------
        preOrder_f4(root);
